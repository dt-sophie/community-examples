...
1. **Download the JSON File**  
   [Download standard version here](DPS Cost Allocation Overview Dashboard v3.8 w Query, Workflow, Functions support.json)
   [Download support for Query/Workflow/Function here](DPS Cost Allocation Overview Dashboard v3.8 w Query, Workflow, Functions support.json)
